...
class Cityscapes(data.Dataset):
    ...
    **Parameters:**
    ...
    classes = [
        ...
        # CityscapesClass('Potholes',             34, 19,  'road' , 1, False, False, (255, 0, 0)), 
    ...
    # train_id_to_color.append([255, 0, 0])
    train_id_to_color = np.array(train_id_to_color)
    
    id_to_train_id = np.array([c.train_id for c in classes])
    # id_to_train_id = np.append(id_to_train_id, 34)  # Potholes train ID
    ...
    #     encoded_target = np.zeros_like(target)
    #     for c in cls.classes:
    #         encoded_target[target == c.id] = c.train_id
    #     return encoded_target


    # @classmethod
    # def decode_target(cls, target):
    #     decoded_target = np.zeros(target.shape + (3,), dtype=np.uint8)
    #     for c in cls.classes:
    #         decoded_target[target == c.train_id] = c.color
    #     # Handle potholes
    #     decoded_target[target == 34] = (255, 0, 0)  # Potholes color
